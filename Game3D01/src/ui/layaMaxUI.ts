...
export module ui.test {
    ...
    export class shengjiEFFUI extends View {
        public static  uiView:any ={"type":"View","props":{"width":100,"height":100},"compId":2,"child":[{"type":"SkeletonPlayer","props":{"y":50,"x":50,"url":"juese/levelUp.sk","runtime":"laya.ani.bone.Skeleton"},"compId":4}],"loadList":["juese/levelUp.sk"],"loadList3D":[]};
        constructor(){ super()}
        createChildren():void {
            super.createChildren();
