(function () {
    ...
    GameConfig.startScene = "test/mainUI.scene";
    ...
    class SdkManagerTT {
        ...
        share(h, type = 0) {
            ...
            Laya.Browser.window.wx.shareAppMessage(obj);
            this.shareStartTime = Laya.Browser.now();
            let chao = this.shareTimes >= SdkManagerTT.SHARE_MAX_TIMES;
    ...
    SdkManagerTT.FLY_BOX = 0;
    SdkManagerTT.GAME_OVER = 1;
    SdkManagerTT.GET_PET = 2;
    SdkManagerTT.TIME_GOLD = 3;
    SdkManagerTT.TREASURE = 4;
    SdkManagerTT.ZHUAN = 5;
    SdkManagerTT.AD_DIALOG = 7;
    SdkManagerTT.NEXT_STAGE_CHAPING = 6;
    SdkManagerTT.REBORTH = 11;
    SdkManagerTT.SHARE_MAX_TIMES = 6;
    ...
    Game.codeVer = "3.0.0.200120";
    Game.resVer = "3.0.0.200120";
    Game.nativefiles = [
